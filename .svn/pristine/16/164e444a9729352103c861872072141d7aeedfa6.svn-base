package com.penta.backoffice.web.schedule.controller;
...
public class ScheduleController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/application/schedule/schedulePN.do", method = { RequestMethod.GET, RequestMethod.POST })
	public String schedulePN(HttpSession session, HttpServletRequest request) {
		...
		return "/application/schedule/schedulePN";
	}
/*
	*//**
	 * 쿠폰관리 리스트 화면
