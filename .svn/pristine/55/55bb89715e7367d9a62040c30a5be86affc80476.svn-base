...
public class LogController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/application/system/log/accessLogPN.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String accessLogPN(HttpSession session, HttpServletRequest request) {
		...
		return "/application/system/log/accessLogPN";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/application/system/log/errorLogPN.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String errorLogPN(HttpSession session, HttpServletRequest request) {
		
		MenuUtil menu = new MenuUtil(session.getAttribute(CommonConstant.SESSION_MENU), request.getServletPath());
		session.setAttribute("menuAuth", menu.getMenuAuth());
		
		return "/application/system/log/errorLogPN";
	}
	/*
	*//**
	 * 스탬프 관리 리스트 화면
