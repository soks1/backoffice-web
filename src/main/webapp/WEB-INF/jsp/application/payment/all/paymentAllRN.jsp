					...
					<div class="widget-body">
						<form class="form-horizontal">
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-2 control-label cs-css-05">전문추적번호 :</label>
									<div class="col-md-2">
										<span class="form-control cs-css-03" id="npmt_trs_id"></span>
									</div>
									<label class="col-md-1 control-label cs-css-05">승인번호 :</label>
									<div class="col-md-2">
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-12">
										<a href="javascript:f_allLN();" class="btn btn-default">목록</a>
									</div>
								</div>
							</div>	
						</form>
