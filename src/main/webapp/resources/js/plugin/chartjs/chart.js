...
(function() {
        ...
        var each = helpers.each = function(loopable, callback, self) {
            ...
            template = helpers.template = function(templateString, valuesObject) {
                ...
                function tmpl(str, data) {
                    ...
                    var fn = !/\W/.test(str) ?
                        ...
                        new Function("obj",
                            ...
                            .replace(new RegExp("((^|" + interpolators.end + ")[^\t]*)'", "g"), "cf_setComma($1)\r")
                            .replace(new RegExp("\t=(.*?)" + interpolators.end, "g"), "', cf_setComma($1) ,'")
                            .split("\t").join("');")
                ...
                //valuesObject.value = cf_setComma(valuesObject.value);
            ...
            retinaScale = helpers.retinaScale = function(chart) {
                ...
                if (window.devicePixelRatio) {
                    ...
                    ctx.canvas.style.height = (height+10) + "px";
                    ctx.canvas.height = (height+10) * window.devicePixelRatio;
                ...
                if (ChartElements.length > 0) {
                    ...
                    if (this.datasets && this.datasets.length > 1) {
                        ...
                        helpers.each(ChartElements, function(Element) {
                            ...
                            //console.log(helpers.template(this.options.tooltipTemplate, Element));
                            new Chart.Tooltip({
        ...
        Chart.MultiTooltip = Chart.Element.extend({
            ...
            draw: function() {
                ...
                if (this.custom) {
                    ...
                    //ctx.fillText(cf_setComma(this.title), this.x + this.xPadding, this.getLineHeight(0));
                    ctx.fillText(this.title, this.x + this.xPadding, this.getLineHeight(0));

                    ctx.font = this.font;
                    helpers.each(this.labels, function(label, index) {
                        ctx.fillStyle = this.textColor;
                        //ctx.fillText(cf_setComma(label), this.x + this.xPadding + this.fontSize + 3, this.getLineHeight(index + 1));
                ...
                if (this.display) {
                    ...
                    each(this.yLabels, function(labelString, index) {
                        ...
                        if (this.showLabels) {
                            ...
                            {
                                this.customYLabel(labelString, xStart-5, yLabelCenter, ctx, index);
                            }else{
                                //ctx.fillText(cf_setComma(labelString), xStart, yLabelCenter);
                    ...
                    each(this.xLabels, function(label, index) {
                        ...
                        //ctx.fillText(cf_setComma(label), 0, 0);
                ...
                if (this.display) {
                    ...
                    each(this.yLabels, function(label, index) {
                        ...
                        if (index > 0) {
                            ...
                            if (this.showLabels) {
                                ...
                                //console.log(cf_setComma(label));
                                //ctx.fillText(cf_setComma(label), this.xCenter, yHeight);
                    ...
                    if (!this.lineArc) {
                        ...
                        for (var i = this.valuesCount - 1; i >= 0; i--) {
                            ...
                            //ctx.fillText(cf_setComma(this.labels[i]), pointLabelPosition.x, pointLabelPosition.y);
