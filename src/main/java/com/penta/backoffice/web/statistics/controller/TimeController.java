...
/**
 * @class : TimeController.java
 * @author : 
 * @since : 
 * @description : 시간별 결제/취소
 * 
...
public class TimeController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/application/statistics/time/statisticsTimePN.do", method = { RequestMethod.GET, RequestMethod.POST })
	public String statisticsTimePN(HttpSession session, HttpServletRequest request) {
		...
		return "/application/statistics/time/statisticsTimePN";
	}
/*
	*//**
	 * 쿠폰관리 리스트 화면
