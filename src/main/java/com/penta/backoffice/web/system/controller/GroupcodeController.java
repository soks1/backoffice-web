...
public class GroupcodeController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/application/system/group_code/groupCodePN.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String groupCodePN(HttpSession session, HttpServletRequest request) {
		...
		return "/application/system/group_code/groupCodePN";
	}
	/*
	*//**
	 * 스탬프 관리 리스트 화면
